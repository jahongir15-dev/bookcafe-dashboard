                            ...
                            <div
                                ...
                                <div className="d-flex">
                                    <div className="unlimited-access-title me-3">
                                        ...
                                        <a href="" target="_blank" className="btn btn-primary fs-2 fw-semibold lh-sm">Buy
                                            Pro</a>
                                    </div>
                ...
                <div className="body-wrapper">
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light">
                            ...
                            <div className="navbar-collapse justify-content-end px-0" id="navbarNav">
                                <ul className="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                                    <a href="" target="_blank" className="btn btn-primary">Download Free</a>
                                    <li className="nav-item dropdown">
                                        <a className="nav-link nav-icon-hover" href="" id="drop2"
                    ...
                    <div className="container-fluid">
                                        ...
                                        <ul className="timeline-widget mb-0 position-relative mb-n5">
                                            <li className="timeline-item d-flex position-relative overflow-hidden">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        className="timeline-badge border-2 border border-primary flex-shrink-0 my-8"/>
                                            ...
                                            <li className="timeline-item d-flex position-relative overflow-hidden">
                                                ...
                                                <div
                                                    className="timeline-badge-wrap d-flex flex-column align-items-center">
                                                    <span
                                                        className="timeline-badge border-2 border border-info flex-shrink-0 my-8"/>
                                                    <span className="timeline-badge-border d-block flex-shrink-0"/>
                                                </div>
                                            ...
                                            <li className="timeline-item d-flex position-relative overflow-hidden">
                                                ...
                                                <div
                                                    className="timeline-badge-wrap d-flex flex-column align-items-center">
                                                    <span
                                                        className="timeline-badge border-2 border border-success flex-shrink-0 my-8"/>
                                                    <span className="timeline-badge-border d-block flex-shrink-0"/>
                                                </div>
                                            ...
                                            <li className="timeline-item d-flex position-relative overflow-hidden">
                                                ...
                                                <div
                                                    className="timeline-badge-wrap d-flex flex-column align-items-center">
                                                    <span
                                                        className="timeline-badge border-2 border border-danger flex-shrink-0 my-8"/>
                                                    <span className="timeline-badge-border d-block flex-shrink-0"/>
                                                </div>
                                    ...
                                    <div className="position-relative">
                                        ...
                                        <a href=""
                                           ...
                                           data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
                                            className="ti ti-basket fs-4"/></a></div>
                                    <div className="card-body pt-3 p-4">
                                        <h6 className="fw-semibold fs-4">Boat Headphone</h6>
                                        <div className="d-flex align-items-center justify-content-between">
                                            <h6 className="fw-semibold fs-4 mb-0">$50 <span
                                                className="ms-2 fw-normal text-muted fs-3"><del>$65</del></span></h6>
                                            <ul className="list-unstyled d-flex align-items-center mb-0">
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                                </li>
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                                </li>
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                                ...
                                                <li><a className="" href=""><i className="ti ti-star text-warning"/></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card-body pt-3 p-4">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            <h6 className="fw-semibold fs-4 mb-0">$650 <span
                                                className="ms-2 fw-normal text-muted fs-3"><del>$900</del></span></h6>
                                            <ul className="list-unstyled d-flex align-items-center mb-0">
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                                </li>
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                    ...
                                    <div className="card-body pt-3 p-4">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            <h6 className="fw-semibold fs-4 mb-0">$150 <span
                                                className="ms-2 fw-normal text-muted fs-3"><del>$200</del></span></h6>
                                            <ul className="list-unstyled d-flex align-items-center mb-0">
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                                </li>
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                    ...
                                    <div className="card-body pt-3 p-4">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            <h6 className="fw-semibold fs-4 mb-0">$285 <span
                                                className="ms-2 fw-normal text-muted fs-3"><del>$345</del></span></h6>
                                            <ul className="list-unstyled d-flex align-items-center mb-0">
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                                                </li>
                                                <li><a className="me-1" href=""><i className="ti ti-star text-warning"/></a>
                        ...
                        <div className="py-6 px-6 text-center">
                            <p className="mb-0 fs-4">Design and Developed by <a href="" target="_blank"
                                                                                className="pe-1 text-primary text-decoration-underline">AdminMart.com</a> Distributed
                                by <a href="">ThemeWagon</a></p>
                        </div>
                    </div>
                </div>
            </div>
